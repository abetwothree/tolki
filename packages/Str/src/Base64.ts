export class Base64 {
    ...
    private static utf8ToBinary(value: string): string {
    ...
    private static manualBase64Encode(binary: string): string {
        const chars =
    ...
    private static manualBase64DecodeToBytes(input: string): number[] {
        const alphabet =
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
    ...
    static toBase64(value: string): string {
        ...
        if (typeof g.btoa === "function") {
            try {
                const binary = this.utf8ToBinary(value);
        ...
        const utf8Binary = this.utf8ToBinary(value);
        return this.manualBase64Encode(utf8Binary);
    }
    ...
    static fromBase64(value: string, strict: boolean = false): string | false {
        ...
        try {
            const bytes = this.manualBase64DecodeToBytes(input);
